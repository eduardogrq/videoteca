...
const Sidebar = () => {
    return (
        <div className="flex text-sm">
            <div className="animate__animated animate__fadeInLeft fixed top-0 left-0 h-full w-4/5 md:w-2/5 lg:w-64 lg:relative lg:min-h-screen z-50 bg-gray-800 px-5 lg:px-10 py-10">
                        ...
                        <div className="flex justify-between items-center w-full">
                            <div className="flex items-center gap-3 cursor-pointer">
                                <img src="https://picsum.photos/seed/picsum/40/40"
                                    ...
                                    alt=""
                                />
                                <span className="lg:text-xs">Eduardo Quiñonez</span>
                            </div>
